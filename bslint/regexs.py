...
List = [
    ...
    Token._make([";", const.SEMI_COLON, const.NO_INDENTATION]),
    Token._make(["@", const.AT_SYMBOL, const.NO_INDENTATION]),
    Token._make(["#", const.HASH_SYMBOL, const.NO_INDENTATION]),
    ...
    Token._make([r"(Tan)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Sqr)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Sin)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Sgn)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Log)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Int)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Fix)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Exp)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Cint)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Cdbl)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Csng)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Cos)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Atn)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Abs)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Substitute)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Tr)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Val)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Stringi)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Stri)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Str)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Right)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Len)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Left)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Instr)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Chr)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Asc)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(LCase)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Ucase)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(FormatJson)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(ParseJson)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(RunGarbageCollector)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(strtoi)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(FormatDrive)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(CreateDirectory)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(DeleteDirectory)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(DeleteFile)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(MatchFiles)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(MoveFile)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(CopyFile)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(WriteAsciiFile)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(ReadAsciiFile)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(RebootSystem)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(UpTime)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(GetInterface)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Wait)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Sleep)\b", const.KEYWORD, const.NO_INDENTATION]),
    ...
    Token._make([r"(FindMemberFunction)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Rnd)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Type)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Void)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Dynamic)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Float)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Double)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Integer)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(LongInteger)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(String)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Boolean)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Object)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Until)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(On)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Library)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Generates)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Implements)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Event)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Interface)\b", const.KEYWORD, const.NO_INDENTATION]),
    Token._make([r"(Component)\b", const.KEYWORD, const.NO_INDENTATION]),
