...
RULES_LIST = {
    const.PRIORITY_ZERO: [
        ...
        ([const.EXIT_STMT], const.BLOCK_STMT),
        ([const.PRINT_STMT], const.BLOCK_STMT),
        ([const.FUNCTION_CALL], const.BLOCK_STMT),
        ([const.VAR_AS], const.BLOCK_STMT),
        ([const.RETURN_STMT], const.BLOCK_STMT),
