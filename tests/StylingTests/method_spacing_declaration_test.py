...
class TestMethodSpacingDeclaration(unittest.TestCase):
    ...
    def testInvalidDeclarationWithNoSpaceBetweenParams(self):
        bslint.load_config_file(user="CheckMethodDeclaration/active_method_spacing_declaration.json",
    ...
    def testValidDeclarationWithExtraSpacesInParams(self):
        bslint.load_config_file(user="CheckMethodDeclaration/active_method_extra_spacing_declaration.json", default='test-config.json')
