import src.ErrorMessagesBuilder.ErrorBuilder.ErrorMessageBuilder as ErrBuilder
...
ERROR_TABLE = {
        ...
        TAB_INDENTATION_ERROR: ErrBuilder.Error(WARNING + ": Tab indentation should be set to {} number of spaces. Line number: {}"),
        TAB_AND_SPACES: ErrBuilder.Error(WARNING + ": Invalid indentation, you can use tabs or spaces but not both. Line number: {}"),
        ...
        NO_SPACE_AROUND_OPERATORS: ErrBuilder.Error(WARNING + ": Operators must be surrounded by one space. Line number: {}"),
