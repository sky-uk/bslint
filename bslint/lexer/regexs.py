...
regexs_list = [
    ...
    [";", const.SEMI_COLON, const.SEMI_COLON, const.NO_INDENTATION],
    ["@", const.AT_SYMBOL, const.AT_SYMBOL, const.NO_INDENTATION],
    ["#", const.HASH_SYMBOL, const.HASH_SYMBOL, const.NO_INDENTATION],
    [r"\.", const.SPECIAL_OPERATOR, const.DOT, const.NO_INDENTATION],
    [":", const.COLON, const.COLON, const.NO_INDENTATION],
    [r"\^", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    [r"\&", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    [r"\\", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    ["=", const.OPERATOR, const.EQUALS, const.NO_INDENTATION],
    ["-", const.OPERATOR, const.MINUS, const.NO_INDENTATION],
    ["\+", const.OPERATOR, const.PLUS, const.NO_INDENTATION],
    ["\*", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    [r"/", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    ["<", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    [">", const.OPERATOR, const.OPERATOR, const.NO_INDENTATION],
    ...
    [",", const.SPECIAL_OPERATOR, const.COMMA, const.NO_INDENTATION],
    ...
    [r"(ELSE IF)\b", const.KEYWORD, const.IF_STATEMENT, const.SPECIAL_INDENTATION],
    ...
    [r"(CREATEOBJECT)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(ELSEIF)\b", const.KEYWORD, const.IF_STATEMENT, const.SPECIAL_INDENTATION],
    ...
    [r"(Tan)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Sqr)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Sin)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Sgn)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Log)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Int)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Fix)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Exp)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Cint)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Cdbl)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Csng)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Cos)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Atn)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Abs)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Substitute)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Tr)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Val)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    ...
    [r"(Wait)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    [r"(Sleep)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    ...
    [r"(Event)\b", const.KEYWORD, const.KEYWORD, const.NO_INDENTATION],
    ...
    [r"(IF)\b", const.KEYWORD, const.IF_STATEMENT, const.INCREMENT_INDENTATION],
    [r"(THEN)\b", const.KEYWORD, const.THEN, const.INCREMENT_INDENTATION],
    [r"(ELSE)\b", const.KEYWORD, const.KEYWORD, const.SPECIAL_INDENTATION],
    ...
    [r"(INVALID)\b", const.KEYWORD, const.INVALID, const.NO_INDENTATION],
    ...
    [r"('|rem) *(BSLINT)_(?P<command>[a-z_]+)(:(?P<param>[0-9]+))?.*", const.BSLINT_COMMAND, const.BSLINT_COMMAND, const.NO_INDENTATION],
    ...
    ["\?", const.PRINT_KEYWORD, const.PRINT_KEYWORD, const.NO_INDENTATION],
