...
class TestMethodSpacingDeclaration(unittest.TestCase):
    ...
    def testValidDeclaration(self):
        bslint.load_config_file(user_filepath="CheckMethodDeclaration/active_method_spacing_declaration.json", default_filepath='test-config.json')
    ...
    def testInvalidDeclarationWithNoSpaceBetweenParams(self):
        bslint.load_config_file(user_filepath="CheckMethodDeclaration/active_method_spacing_declaration.json",
    ...
    def testValidDeclarationWithExtraSpacesInParams(self):
        bslint.load_config_file(user_filepath="CheckMethodDeclaration/active_method_extra_spacing_declaration.json", default_filepath='test-config.json')
