...
class TestErrorHandling(unittest.TestCase):
    ...
    def test_no_warnings_in_file_with_errors(self):
        ...
        self.assertEqual(len(self.interface_handler.messages[self.ERRORS]), 1)
        self.assertEqual(len(self.interface_handler.messages[self.WARNINGS]), 0)
    ...
    def test_only_warnings_in_file_without_errors(self):
        ...
        self.assertEqual(len(self.interface_handler.messages[self.ERRORS]), 0)
        self.assertEqual(len(self.interface_handler.messages[self.WARNINGS]), 1)
