...
class TestForParse(unittest.TestCase):
    ...
    def test_for_value_no_step(self):
        self.common.match_statement("for x=10 To 3", const.FOR_STMT)

    def test_for_id_no_step(self):
        self.common.match_statement("for x=10 To y", const.FOR_STMT)

    def test_for_function_call_no_step(self):
        self.common.match_statement("for x=10 To y()", const.FOR_STMT)

    def test_for_value_step_value(self):
        self.common.match_statement("for x=10 To 3 Step 2", const.FOR_STMT)

    def test_for_id_step_value(self):
        self.common.match_statement("for x=10 To y Step 2", const.FOR_STMT)

    def test_for_function_call_step_value(self):
        self.common.match_statement("for x=10 To y() Step 2", const.FOR_STMT)

    def test_for_value_step_id(self):
        self.common.match_statement("for x=10 To 3 Step zz", const.FOR_STMT)

    def test_for_id_step_id(self):
        self.common.match_statement("for x=10 To y Step zz", const.FOR_STMT)
